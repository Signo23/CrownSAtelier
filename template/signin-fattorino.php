<form>
  ...
  <form class="needs-validation" novalidate>
    ...
    <div class="form-floating">
      <label for="patente" class="form-label">Patente di guida</label>
      <input type="text" class="form-control" id="patente" placeholder="" value="" required>
      <div class="invalid-feedback">
        La patente di guida &egrave; obbligatoria.
      </div>
    </div>
    <div class="form-floating">
      <label for="mezzo" class="form-label">Mezzo di trasporto</label>
      <input type="text" class="form-control" id="mezzo" placeholder="" value="" required>
      <div class="invalid-feedback">
        Il mezzo di guida &egrave; obbligatorio.
      </div>
    </div>
    <div class="form-floating">
      <label for="cellulare" class="form-label">Cellulare</label>
